...
$sql = "SELECT CONCAT(People.fname, ' ', People.lname) AS Name, 
        ...
        WHERE CONCAT(People.fname, ' ', People.lname)='$name' and Exercises.e_name='$e_name'";
...
if (mysqli_num_rows($result) > 0) {
    ...
    print "$top_full_name$top_workout_name$top_sets$top_weight$top_date\n";
    while($row = mysqli_fetch_array($result, MYSQLI_BOTH)){
        ...
        print "$full_name$workout_name$sets$weight$date\n";
    }
    print "</pre>";
} else {
